...
print("Logistic Regration acc:",z)


from sklearn.ensemble import RandomForestClassifier
 
loan_model1 = RandomForestClassifier()
# Fitting Random Forest Classifier to the Training set
loan_model1.fit(X_train, Y_train)
Y_pred1 = loan_model1.predict(X_test)
rfc = loan_model1.score(X_test, Y_test)

print("Random Forest Accuracy: ",rfc)
